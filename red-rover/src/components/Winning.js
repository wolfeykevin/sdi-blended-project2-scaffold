...
let opportunityObj = {name: 'Opportunity', purpose: "NASA's Opportunity rover was one of the most successful and enduring interplanetary missions. Opportunity landed on Mars in early 2004 soon after its twin rover Spirit. Opportunity operated almost 15 years, setting several records and making a number of key discoveries.", mass: 2341, launchDate: 'Jul 7, 2003', landingDate: 'Jan 25, 2004', totalImages: 198439, cardImg: '/images/rover-card-3-opportunity.png'}
 ...
 if(path.includes('curiosity')) {
  ...
  return (
    <>
    <h1 className='winning-header'>The winner is... {selected.name}!</h1>

    <div className='flex-contain'>
      <img className='cardImg' src={selected.cardImg} alt={selected.name}/>
    ...
    <h2 className="winning-header">{selected.name}'s photographs:</h2>
    <div className="winning-photos">
      {
